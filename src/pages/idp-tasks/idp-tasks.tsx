...
const IdpTasks: FC = () => {
  const { title, tasks, isRequest, isSuccess, isFailed, errorMessage } =
    useAppSelector(state => state.idpTasks)
        ...
        <div className={styles.container}>
          ...
          {hasTasks ? (
            ...
            <p className={styles.message}>
              На данный момент у вас нет задач к этому ИПР. Обратитесь к вашему
              руководителю.
            </p>
          )}
        </div>
