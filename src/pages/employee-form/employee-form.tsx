...
const EmployeeForm: FC = () => {
  const user: TUser = {
    ...
    supervisor: ['Александров Александр Александрович', 'Борисов Борис Борисович', 'Васильев Василий Васильевич']
  }
  ...
  const autofill = (user: TUser) => {
    if (user && user.fullName && user.department && user.position && user.supervisor.length)
      setValues({
